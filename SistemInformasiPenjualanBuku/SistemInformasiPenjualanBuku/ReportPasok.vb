...
Public Class ReportPasok
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemInformasiPenjualanBuku.ReportPasok.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPasok
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPasok = New ReportPasok()
        rpt.Site = Me.Site
        Return rpt
    End Function
