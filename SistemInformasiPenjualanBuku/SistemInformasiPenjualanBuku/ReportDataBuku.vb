...
Public Class ReportDataBuku
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemInformasiPenjualanBuku.ReportDataBuku.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDataBuku
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDataBuku = New ReportDataBuku()
        rpt.Site = Me.Site
        Return rpt
    End Function
