...
Public Class ReportPegawai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemInformasiPenjualanBuku.ReportPegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPegawai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPegawai = New ReportPegawai()
        rpt.Site = Me.Site
        Return rpt
    End Function
